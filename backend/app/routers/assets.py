...
def create_asset(
    ...
    return crud.create_asset(db, data, current_user)
...
def allocate_asset(
    ...
    return crud.allocate_asset(db, asset_id, data, current_user)
...
def return_asset(
    ...
    return crud.return_asset(db, asset_id, data, current_user)
...
def scrap_asset(
    ...
    return crud.scrap_asset(db, asset_id, data, current_user)
